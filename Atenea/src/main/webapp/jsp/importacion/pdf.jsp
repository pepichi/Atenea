<%-- 
    Document   : pdf
    Created on : 5 jun 2024, 18:45:00
    Author     : José Puerta Cardelles
--%>
<%@page contentType="text/html" pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html lang="es" ng-app="pdfApp">
    <head>
        <%@include file="/WEB-INF/jspf/comun/configuracionPagina.jspf"%>
        <%@include file="/WEB-INF/jspf/comun/importsAngular.jspf"%>
        <script src="/Atenea/js/angular/controladores/importadores/pdf.js"></script>
        <link rel="stylesheet" href="/Atenea/css/paleta.css">
    </head>
    <body>
        <h1 class="h1MetodoImportacion">Importación fichero PDF</h1>
        <div ng-controller="subidaFicheroController">
            <fieldset class="categoriaContainer centrado">
                ...
                <p>Aquí hay que seleccionar el fichero PDF que tiene las preguntas</p>
